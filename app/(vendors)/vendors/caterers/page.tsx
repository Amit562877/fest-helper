...
export default function CaterersPage() {
  const topRated = caterers.filter((c) => c.rating >= 9);
  const others = caterers.filter((c) => c.rating < 9);
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 sm:px-10 py-12">
      <h1 className="text-4xl font-extrabold mb-10 text-purple-700 tracking-wide">Caterers</h1>
